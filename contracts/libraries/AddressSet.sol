...
library AddressSet {
    ...
    function isMember(Storage memory store, address addr) internal view returns (bool) {
    ...
    function add(Storage memory store, address addr) internal {
        ArbosStorage arbosStorage = ArbosStorage(store.addr);
    ...
    function remove(Storage memory store, address addr) internal {
        ArbosStorage arbosStorage = ArbosStorage(store.addr);
    ...
    function add(AddressSetStorage memory self, address addr) internal {
        add(self.store, addr);
    }

    function remove(AddressSetStorage memory self, address addr) internal {
