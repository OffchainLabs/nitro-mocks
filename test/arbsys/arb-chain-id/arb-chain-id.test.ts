...
import { expectEquivalentCall, expectEquivalentCallFromMultipleAddresses, storageComparerExcludingVersion } from "../../utils/expect-equivalent";
...
describe("ArbSys.arbChainID", function () {
  ...
  it("should behave equivalently to the underlying precompile", async function () {
